<%@ page contentType="text/html; charset=utf-8" language="java" import="java.sql.*" errorPage="" %><%@page import="java.util.List"%><%@page import="com.hyacinth.model.Passage"%><%@page import="com.hyacinth.factory.DAOFactory"%><%@page import="java.util.Iterator"%>
...
<div class="wapper">
	...
	<div class="z">
		<div class="uinfo">
			<div class="u-face"><img src="images/test120X90.jpg" width="120" height="90" /></div>
				<div class="r-info">
					<!-- 分割线 -->
		...
		<div class="microblog">
		<%	
			List<Passage> allpsg = DAOFactory.getPassageclassDAOInstnace().findAll(null);
			Iterator<Passage> it = allpsg.iterator();
			...
			<%=allpsg==null %>
			<div class="container" style=" border-color:#69F; background:#CDE9ED; padding:2em; margin:1em">
			<h2><%=psg.getTitle()%></h2>
			<img src="<%=psg.getUrl()%>" />
			<h3><%=psg.getContent() %></h3>
			</div>
		...
		<!--左导航栏-->
	 	<div id="left_navigator" style="padding:0">
			<ul class="menu_body"> 
    		<li onmouseover="this.style.backgroundColor='#95DDFF'" onmouseout="this.style.backgroundColor='#FFF'"><a href="myPage.jsp" style="background-image:	url(img/correct.jpg)"> My Mainpage</a></li>
        	...
        	<li onmouseover="this.style.backgroundColor='#95DDFF'" onmouseout="this.style.backgroundColor='#FFF'"><a href="Ohterthings.jsp"> Otherthings</a></li>
      	 	</ul>
      	</div>
	</div>
	</div>
