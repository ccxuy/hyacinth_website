...
<div class="wapper">
    <div class="main">
		...
		<div class="nav_main">
			<form action="" method="get"
						...
						<a href="blog.jsp" id="nav_a5"
							class="ui-state-default ui-corner-all nav_link"> <span
							class="ui-icon ui-icon-newwin"></span>微博 </a>
					</form>
		</div>	
	...
	<!--左导航栏-->
	  <div id="left_navigator" style="padding:0">
			<ul class="menu_body"> 
    		<li><a href="blog.jsp"> My Mainpage</a></li>
    		<li><a href="postCenter.jsp">Post Center</a></li>  
    		<li><a href="postHtml.jsp"> Post HTML</a></li> 
        	<li><a href="userConfig.jsp"> Personal Settings</a></li>
      	 </ul>
       </div>
	  ...
	  <form action="passage_upload.jsp" method="post" enctype="multipart/form-data">
        	<p>标题</p>
            <br />
            <div class="posting_form">
      		<input name="passage_titile" type="text" class="text_posting" style="width:775px;"/>
            </div>
        	<br />
			
			<p>显示图片 - (大小为120X90的图片最佳)</p>
            <br />
            <div class="posting_form">
      		<input type="file" name="passage_pic">
            </div>
        	<br />
            ...
            <br />
            <div class="posting_form">
      		<textarea name="passage_content" id="wysiwyg" class="text_posting" style="width:770px;height:470px;"></textarea>  <!-- textarea -->
            </div>
            <!-- testing
			...
			<input type="reset" id="text_reset" class="ui-state-default"/> <!--submit button-->
        	</div>
		</form>
      </div>
