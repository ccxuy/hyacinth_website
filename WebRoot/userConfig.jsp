...
<div class="wapper">
	...
	<!--左导航栏-->
	  <div id="left_navigator" style="padding:0">
			<ul class="menu_body"> 
    		<li><a href="myPage.jsp"> My Mainpage</a></li>
       ...
       <!--文本编辑框-->
      <div id="posting" >
	  <form action="userConfigUpload.jsp" method="post" enctype="multipart/form-data">
        	<p>显示名字</p>
            <br />
            <div class="posting_form">
      		<input name="userName" type="text" class="text_posting" style="width:775px;"/>
            </div>
        	<br />
			
			<p>上传头像 - (大小为120X90的图片最佳)</p>
            <br />
            <div class="posting_form">
